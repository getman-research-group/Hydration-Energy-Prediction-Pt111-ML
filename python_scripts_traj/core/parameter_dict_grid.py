...
PARAMETER_DICT_GRID = {
    ...
    'SVR': {
        ...
        'C': [0.1, 0.2, 0.5, 1, 2, 5, 10],  # default = 1
        ...
        'epsilon': [0.002, 0.005, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5],  # default = 0.1
    ...
    'Bayesian_Ridge': {
        'alpha_1':  [1e-06, 1e-05, 1e-04, 1e-03, 1e-2],  # default=1e-6
        'alpha_2':  [1e-06, 1e-05, 1e-04, 1e-03, 1e-2],  # default=1e-6
        'lambda_1': [1e-06, 1e-05, 1e-04, 1e-03, 1e-2],  # default=1e-6
        'lambda_2': [1e-06, 1e-05, 1e-04, 1e-03, 1e-2],  # default=1e-6
        },
    ...
    'Random_Forest': {
        ...
        'n_estimators'      :[20, 40, 60, 80], # default = 100
        
        # more depth may result in overfitting.
        # Less depth may result in underfitting.
        # In general, this value can be ignored when there is little data or few features.
        'max_depth'         : [None, 2, 5, 6, 7, 8], # Default = None
    ...
    'XGBoost': {
        ...
        'alpha': [0, 0.01, 0.1, 1],                   # default = 0
        
        ## L2 regularization term on weights. Increasing this value will make model more conservative.
        'lambda': [0.1, 1, 10, 100],                  # default = 1
    ...
    'LightGBM': {
            ...
            'min_data_in_leaf': [10, 20, 50],       # default = 20
            'learning_rate': [0.05, 0.1],           # default = 0.1
            'num_iterations': [50, 100, 150],       # default = 100
    ...
    'MLP':  {
        ...
        'hidden_layer_sizes': [(50,), (100,), (50, 50), (100, 50), (100, 100), (50, 50, 50), (100, 50, 25), (100, 100, 50), (100, 100, 100), (50, 50, 50, 50), (100, 50, 25, 12), (100, 100, 50, 25)],
