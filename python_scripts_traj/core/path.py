...
def get_paths(path):
    ...
    path_dic = {
        ...
        'md_descriptors_90'      : os.path.join(base_path, 'database', 'label_data', 'E_int_90.csv'),
        'md_descriptors_450'     : os.path.join(base_path, 'database', 'label_data', 'E_int_450.csv'),
        ...
        'output_model_path'      : os.path.join(base_path, 'output_model'),
