...
PARAMETER_DICT_BAYESIAN = {
    ...
    'SVR': {
        ...
        'epsilon'       : Real(0.02, 0.2),     # default = 0.1
        },
    ...
    'Gradient_Boost': {
        ...
        'learning_rate'     : Real(0.01, 0.2, prior = 'log-uniform'),   # default = 0.1
        'n_estimators'      : Integer(50, 100),                         # default = 100
        'subsample'         : Real(0.8, 1.0, prior = 'uniform'),        # default = 1.0
        'max_depth'         : Integer(2, 5),                            # default = 3
        'max_features'      : Categorical([None, 'log2', 'sqrt']),      # Default = None
        'min_samples_split' : Integer(2, 4),                            # default = 2
        'min_samples_leaf'  : Integer(1, 3),                            # default = 1
        },
    ...
    'MLP':  {
        'hidden_layer_sizes': Categorical([(50,), (100,), (50, 50), (100, 50, 25)]),
        ...
        'max_iter'          : Integer(100, 500),                           # default = 200
        },
