...
DESCRIPTORS_CONFIG = {
    ...
    'E_int_450_adsorbate_3d_whim_vdw.csv':[
                                            ...
                                            'adsorbate_3d_whim_vdw_Weta1',
                                            'adsorbate_3d_whim_vdw_Weta2',
                                            'adsorbate_3d_whim_vdw_Weta3',
                                            
                                            'adsorbate_3d_whim_vdw_WT',
                                            'adsorbate_3d_whim_vdw_WA',
                                            'adsorbate_3d_whim_vdw_WV',
                                            'adsorbate_3d_whim_vdw_WK',
                                            'adsorbate_3d_whim_vdw_WD',
    ...
    'E_int_450_adsorbate_chemaxon.csv': [
                                        ...
                                        'adsorbate_Platt_idx',
                                        'adsorbate_Randic_idx',
                                        'adsorbate_Blaban_idx',
                                        'adsorbate_Harary_idx',
                                        'adsorbate_Hyper_wiener_idx',
                                        'adsorbate_Szeged_idx',
                                        'adsorbate_Wiener_idx',
                                        'adsorbate_Wiener_polarity',
                                        ],
